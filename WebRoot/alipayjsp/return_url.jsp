...
<%
	...
	//extra_common_param(公用回传参数,用于商户回传参数，该值不能包含“=”、“&”等特殊字符。
		...
		if(trade_status.equals("TRADE_FINISHED") || trade_status.equals("TRADE_SUCCESS")){
			...
			//判断该笔订单是否在商户网站中已经做过处理
				...
				//如果有做过处理，不执行商户的业务程序
  				...
  				Boolean b=m.zhiFuBaoMoney( r_id, user,Double.parseDouble(total_fee),1,buyer_email,trade_no,out_trade_no);//插入记录log
  				if(b){
					//out.println("商户订单号:"+out_trade_no +"<br />支付宝交易号:"
					//+trade_no +"<br />交易状态" +trade_status+
					//"<br />买家支付宝帐号" +buyer_email+"/n交易金额" +total_fee
